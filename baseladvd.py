...
class basedb(Abstractbase):
    ...
    def insert_db(self,Tweeti):
        ...
        self.conn.commit()
        print ('Datos Insertados ({}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {})'.format(Tweeti.user_id,Tweeti.handle,Tweeti.lugar,Tweeti.verificado,Tweeti.followers,Tweeti.numtweets,Tweeti.friends,Tweeti.description,Tweeti.lenguaje,Tweeti.profile,Tweeti.Ranking,Tweeti.Categoria,Tweeti.Victorias,Tweeti.Derrotas))
        return True
